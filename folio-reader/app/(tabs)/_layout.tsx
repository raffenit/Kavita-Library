...
function getIconPaths(name: string): string[] {
  const paths: Record<string, string[]> = {
    ...
    'book': ['M3 6c0-.83.67-1.5 1.5-1.5L12 7l7.5-2.5c.83 0 1.5.67 1.5 1.5v12c0 .83-.67 1.5-1.5 1.5L12 21l-7.5-2c-.83-.33-1.5-1-1.5-1.5V6zm2 0v10l6.5 1.5V8L5 6zm12 0l-6.5 1.5v10L19 17.5V6z'],
